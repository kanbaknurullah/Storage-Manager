...
public class Type {
  ...
  public Type(String typeStr) {
    ...
    this.nOfFields = Integer.valueOf(parts[2]).intValue();
  ...
  public static void create(File file) {
    try {
      ...
      Logger.input("Enter number of fields: [1-10]");
      ...
      if (sysPage.pageHeader.getNofRecords() == 10) {
  ...
  public static void delete(File file) {
    try {
      ...
      int loc = -1;
      while (loc == -1) {
        for (int j = 0; j < sysPage.records.size(); j++) {
          if (((String)sysPage.records.get(j)).equalsIgnoreCase(type.toString())) {
            loc = j;
            break;
          } 
        } 
  ...
  public String toString() {
    ...
    parts.add(Integer.toString(this.nOfFields));
